...
class Container extends React.Component {
  ...
  localStorageSetGet = (props) => {
    try {
      ...
      if (this.lsTest() === true && typeof localStorage !== "undefined") {
        if (props == "setLocal") {
          $(`.settingRememberfld`).html(
            `<i className="fa fa-spinner" aria-hidden="true">&nbsp;Loading...</i>`
          );
          ...
          setTimeout(function () {
            $(`.settingRememberfld`).html(
              `<i className="zmdi zmdi-check-circle">&nbsp;Saved</i>`
            );
          }, 500);
        ...
        throw new Error(
          "LocalStorageError: Can't Find Or Immutable Or Storage Limit Exceeded"
        );
      }
    } catch (err) {
      console.log(err);
      $(`.settingRememberfld`).html(
        `<i className="zmdi zmdi-alert-polygon">&nbsp;Error : Can't Set As Default</i>`
      );
  ...
  penSelectClick = () => {
    ...
    $(`.penSizeCon i.active`).css({
      color: `${$(".penColorSelectCon i.fa-palette").css("color")}`,
    });
  ...
  eraserSelectClick = () => {
    ...
    $(`.penSizeCon i.active`).css({
      color: `${$(".eraserColorSelectCon i.fa-eraser").css("color")}`,
    });
    $(`.penColorSelectCon i`).removeClass("active");
    $(`.eraserColorSelectCon i`).removeClass("active");
  ...
  bgAndEraserColorSelectChange = (color) => {
    ...
    $(`.bgColorSelectCon i.zmdi-format-color-fill`).css({
      color: `${color.hex}`,
    });
    this.setState({
  ...
  settingBgSelectorOne(params) {
    ...
    $(`.containerCus, .liveBgColorSetting`).css({
      background: `linear-gradient(45deg, ${this.state.bgSettingOne}, ${this.state.bgSettingTwo})`,
    });
  }
              ...
              switch (this.state.pickerType) {
                case "1":
                  return (
                    <SketchPicker
                      color={this.state.brushColor}
                      onChange={this.penColorSelectChange}
                    />
                  );
                case "2":
                  return (
            ...
            {(() => {
              switch (this.state.pickerType) {
                case "1":
                  return (
                    <SketchPicker
                      color={this.state.erasercolor}
                      onChange={this.bgAndEraserColorSelectChange}
                    />
                  );
                case "2":
                  return (
      ...
      <div className="containerCus">
        <div className="tools-section d-f_jc-c_ai-c mb-1">
          <div className="penColorSelectCon">
            <i
              className="fas fa-palette active"
              title="Right Click Or Left Double Click To Open The Brush Color Palet Selector Tool  | Alt+r"
              onContextMenu={(e) => {
                e.preventDefault();
                pencilColorSellectClick();
              }}
              ...
              onClick={this.penSelectClick}
            ></i>
            <div
              className="modalCus sketch-picker-com"
              id="penColorSelectModel"
            >
              <div className="modal-dialog m-0">
                <div className="modal-content w-max-con bg-none border-none">
                  <div className="modal-body p-0">
                    <h4 className="tx-c colorPickerHeading">
                      Select Brush Color
                    </h4>
                    {colorPicker("penRet")}
                  </div>
          ...
          <div
            className="eraserColorSelectCon"
            title="Left Click To Select Eraser | Alt+r"
          >
          ...
          <div className="bgColorSelectCon">
            <i
              className="zmdi zmdi-format-color-fill"
              title="Left Click To Open Board Color Palet"
              data-bs-toggle="modal"
              data-bs-target="#bgcolorsel"
            ></i>
            <div
          ...
          <div className="penSizeCon">
            <span>
              <i
                ...
                title="Left Click To Select Size 2 | Ctrl+Alt+1"
                className="zmdi zmdi-edit penSize2 active"
              ></i>
              <i
                onClick={() => {
                  changeBrushSizeClickSelect(5);
                }}
                title="Left Click To Select Size 5 | Ctrl+Alt+2"
                className="fas fa-pencil-alt penSize5"
              ></i>
              <i
                onClick={() => {
                  changeBrushSizeClickSelect(10);
                }}
                title="Left Click To Select Size 10 | Ctrl+Alt+3"
                className="zmdi zmdi-brush penSize10"
              ></i>
            </span>
            <span>
              <i
                ...
                title="Left Click To Select Size 15 | Ctrl+Alt+4"
                className="fas fa-paint-brush penSize15"
              ></i>
              <i
                onClick={() => {
                  changeBrushSizeClickSelect(20);
                }}
                title="Left Click To Select Size 20 | Ctrl+Alt+5"
                className="fas fa-brush penSize20"
              ></i>
              <i
                onClick={() => {
                  changeBrushSizeClickSelect(25);
                }}
                title="Left Click To Select Size 25 | Ctrl+Alt+6"
                className="fas fa-paint-roller penSize25"
              ></i>
            </span>
          </div>
          ...
          <div className="setManiCon">
            <div className="settingCon">
              <i
                ...
                title="Left Click To Open Setting's | Alt+s"
                onClick={() => {
                  settingsModalBtnClick();
                }}
                data-bs-toggle="modal"
                  ...
                  <div className="modal-content w-max-con">
                    <div className="modal-body">
                      <div className="d-flex justify-content-between align-items-center">
                        <label htmlFor="settingPickerType">
                          Select Color Picker Type : &nbsp;
                        </label>
                        <select
                          id="settingPickerType"
                          value={this.state.pickerType}
                          onChange={this.settingPickerTypeSelChange.bind(this)}
                        >
                      ...
                      <div className="d-flex justify-content-between align-items-center">
                        ...
                        <span className="d-f_jc-c_ai-c">
                          ...
                          <input
                            type="color"
                            value={this.state.bgSettingOne}
                            onChange={this.settingBgSelectorOne.bind(this)}
                          />
                          <input
                            type="color"
                            value={this.state.bgSettingTwo}
                            onChange={this.settingBgSelectorTwo.bind(this)}
                          />
                        </span>
                      </div>
                      <div className="d-flex justify-content-between align-items-center">
                        ...
                        <div className="d-f_jc-c_ai-c">
                          <button
                            className="btn btn-light btn- mt-2"
                            id="settingRemember"
                            onClick={() => {
                              this.localStorageSetGet("setLocal");
                            }}
                          >
                            Save
                          </button>
        ...
        <div className="board-container container p-0 shadow-lg rounded">
          <Board
            ...
            canvasbgclr={this.state.erasercolor}
          />
        </div>
